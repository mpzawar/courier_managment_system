...
<tbody>
  <?php 
                    ...
                    $bid = $_SESSION["bid"];
                    $select="SELECT * FROM `shipment_details` WHERE cur_branch in (SELECT name from branch where id=$bid) and status='Book';";
                    ...
                    <tr>
                      ...
                      <td> <a href="javascript:;" class="edit_cstatus" c_id="<?php echo $row['id']; ?>" data-toggle="modal" data-target="#editModal">Confirm Courier</a> </td>
                    </tr>
                                <?php
                                 }  }
                              ?>
